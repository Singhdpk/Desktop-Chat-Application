...
namespace ChatApp
{
    public partial class Form1 : Form
    {
        ...
        private void MessageCallBack(IAsyncResult aResult)
        {
            ...
            try
            {
                ...
                if (size > 0)
                {
                    ...
                    AdmAuthentication admAuth = new AdmAuthentication("espaneoltranslate", "xt0k9FanVoIclyhQCdZM65l6Bx4Tguv16iyu762ih1w=");
                    try
                    {
        ...
        private void textFriendPort_TextChanged(object sender, EventArgs e)
        {
